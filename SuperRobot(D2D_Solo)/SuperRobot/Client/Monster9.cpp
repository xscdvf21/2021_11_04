...
HRESULT CMonster9::Ready_GameObject()
{
	m_tMonInfo.bTurn = false;
	m_tMonInfo.vPos = _vec3(680.f, 180.f, 0.f);
	...
	m_pTextureMonster = L"Monster08";
	pTexInfo = CTexture_Manager::Get_Instance()->Get_TexInfo_TextureMgr(L"Monster", L"Monster08", 0);


	lstrcpy(m_tMonInfo.szUnitName, L"복붙로봇4");
...
int CMonster9::Update_GameObject()
{
	if (m_bDead)
	{
...
void CMonster9::LateUpdate_GameObject()
{
...
void CMonster9::Render_GameObject()
{
...
void CMonster9::Release_GameObject()
{
}

void CMonster9::Move_Check()
{
	//////////////////////
