...
HRESULT CMonster10::Ready_GameObject()
{
	m_tMonInfo.bTurn = false;
	m_tMonInfo.vPos = _vec3(680.f, 220.f, 0.f);
	...
	m_pTextureMonster = L"Monster09";
	pTexInfo = CTexture_Manager::Get_Instance()->Get_TexInfo_TextureMgr(L"Monster", L"Monster09", 0);


	lstrcpy(m_tMonInfo.szUnitName, L"복붙로봇5");
	lstrcpy(m_tMonInfo.szName, L"지원병");
	lstrcpy(m_tMonInfo.szToking, L"「내가 때린다.」");
	lstrcpy(m_tMonInfo.szToking2, L"「내가 맞는다.」");
	m_tMonInfo.iLevel = 2;
	m_tMonInfo.iHp = 100;
...
int CMonster10::Update_GameObject()
{
	if (m_bDead)
	{
...
void CMonster10::LateUpdate_GameObject()
{
...
void CMonster10::Render_GameObject()
{
...
void CMonster10::Release_GameObject()
{
}

void CMonster10::Move_Check()
{
	//////////////////////
