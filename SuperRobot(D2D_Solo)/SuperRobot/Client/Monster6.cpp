...
HRESULT CMonster6::Ready_GameObject()
{
	m_tMonInfo.bTurn = false;
	m_tMonInfo.vPos = _vec3(600.f, 180.f, 0.f);
	...
	m_pTextureMonster = L"Monster05";
	pTexInfo = CTexture_Manager::Get_Instance()->Get_TexInfo_TextureMgr(L"Monster", L"Monster05", 0);
...
int CMonster6::Update_GameObject()
{
	if (m_bDead)
	{
...
void CMonster6::LateUpdate_GameObject()
{
...
void CMonster6::Render_GameObject()
{
...
void CMonster6::Release_GameObject()
{
}

void CMonster6::Move_Check()
{
	//////////////////////
