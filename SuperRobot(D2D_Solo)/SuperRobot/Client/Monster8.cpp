...
HRESULT CMonster8::Ready_GameObject()
{
	m_tMonInfo.bTurn = false;
	m_tMonInfo.vPos = _vec3(640.f, 220.f, 0.f);
	...
	m_pTextureMonster = L"Monster07";
	pTexInfo = CTexture_Manager::Get_Instance()->Get_TexInfo_TextureMgr(L"Monster", L"Monster07", 0);


	lstrcpy(m_tMonInfo.szUnitName, L"복붙로봇3");
...
int CMonster8::Update_GameObject()
{
	if (m_bDead)
	{
...
void CMonster8::LateUpdate_GameObject()
{
...
void CMonster8::Render_GameObject()
{
...
void CMonster8::Release_GameObject()
{
}

void CMonster8::Move_Check()
{
	//////////////////////
