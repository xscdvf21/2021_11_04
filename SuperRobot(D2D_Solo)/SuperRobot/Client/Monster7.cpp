...
HRESULT CMonster7::Ready_GameObject()
{
	m_tMonInfo.bTurn = false;
	m_tMonInfo.vPos = _vec3(600.f, 100.f, 0.f);
	...
	m_pTextureMonster = L"Monster06";
	pTexInfo = CTexture_Manager::Get_Instance()->Get_TexInfo_TextureMgr(L"Monster", L"Monster06", 0);


	lstrcpy(m_tMonInfo.szUnitName, L"복붙로봇2");
...
int CMonster7::Update_GameObject()
{
	if (m_bDead)
	{
...
void CMonster7::LateUpdate_GameObject()
{
...
void CMonster7::Render_GameObject()
{
...
void CMonster7::Release_GameObject()
{
}

void CMonster7::Move_Check()
{
	//////////////////////
