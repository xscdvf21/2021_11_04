...
HRESULT CGraphic_Device::Ready_Graphic_Device(WINMODE eWinMode)
{
	...
	*/
	...
	d3dpp.Windowed = eWinMode;// TRUE일 경우 창모드, FALSE 전체화면. 
...
void CGraphic_Device::Render_Begin()
{
	...
	m_pDevice->Clear(0, nullptr, D3DCLEAR_STENCIL | D3DCLEAR_TARGET | D3DCLEAR_ZBUFFER, D3DCOLOR_ARGB(255, 255, 255, 255), 1.f, 0);
