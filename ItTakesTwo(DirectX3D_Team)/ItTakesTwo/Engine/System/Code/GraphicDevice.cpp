...
HRESULT Engine::CGraphicDevice::Ready_GraphicDev(HWND hWnd,
	WINMODE eMode,
	const _uint& iSizeX,
	const _uint& iSizeY,
...
void Engine::CGraphicDevice::Render_Begin(D3DXCOLOR Color)
{
...
void Engine::CGraphicDevice::Render_End(void)
{
	m_pGraphicDev->EndScene();
	m_pGraphicDev->Present(NULL, NULL, NULL, NULL);
}

void Engine::CGraphicDevice::Free(void)
{
	_ulong dwRefCnt = 0;
