...
CVacuumFieldPart2::CVacuumFieldPart2(LPDIRECT3DDEVICE9 pGraphicDev)
	:Engine::CGameObject(pGraphicDev)
{
}

CVacuumFieldPart2::~CVacuumFieldPart2()
{
}

HRESULT CVacuumFieldPart2::Ready_Object(void* pArg)
{
...
_int CVacuumFieldPart2::Update_Object(const _float & fTimeDelta)
{
...
_int CVacuumFieldPart2::LateUpdate_Object(const _float & fTimeDelta)
{
	_vec3 vPos;
...
void CVacuumFieldPart2::Render_Object(const _int & iIndex)
{
...
HRESULT CVacuumFieldPart2::Add_Component(void* pArg)
{
	...
	// CStaticMesh
	pComponent = m_pMeshCom = dynamic_cast<Engine::CStaticMesh*>(Engine::Clone_Resource(tTemp.eSceneID, L"VacuumPlatform_PartTest"));
...
HRESULT CVacuumFieldPart2::SetUp_ConstantTable(LPD3DXEFFECT & pEffect, const _int & iIndex)
{
...
void CVacuumFieldPart2::MoveDown(const _float & fTimeDelta)
{
	_vec3 vPos;
	_vec3 vUp;
	vPos = m_pTransformCom->Get_Position();
...
void CVacuumFieldPart2::MoveUp(const _float & fTimeDelta)
{
	_vec3 vPos;
	_vec3 vUp;
	vPos = m_pTransformCom->Get_Position();
...
CVacuumFieldPart2 * CVacuumFieldPart2::Create(LPDIRECT3DDEVICE9 pGraphicDev,  void* pArg)
{
	CVacuumFieldPart2*	pInstance = new CVacuumFieldPart2(pGraphicDev);
...
void CVacuumFieldPart2::Free(void)
{
