...
class CChessBishop : public CEnermy
{
	//7, 0, 3, 4
	enum animID {
...
private:
	explicit CChessBishop(LPDIRECT3DDEVICE9 pGraphicDev);
	virtual ~CChessBishop();

public:
	virtual HRESULT Ready_Object(_uint iTileIndex, _uint iCountName);
...
public:
	static CChessBishop*		Create(LPDIRECT3DDEVICE9 pGraphicDev, _uint iTileIndex, _uint iCountName);
	virtual void Free(void)		override;
};

#define __CHESSBISHOP_H__
#endif
