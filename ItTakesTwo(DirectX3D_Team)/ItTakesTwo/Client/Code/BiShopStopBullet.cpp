...
CBiShopStopBullet::CBiShopStopBullet(LPDIRECT3DDEVICE9 pGraphicDev)
	: CEnermy(pGraphicDev)
	, m_bCol(true)
{
}

CBiShopStopBullet::~CBiShopStopBullet()
{
}

HRESULT CBiShopStopBullet::Ready_Object(_vec3 vPos)
{
...
_int CBiShopStopBullet::Update_Object(const _float & fTimeDelta)
{
...
_int CBiShopStopBullet::LateUpdate_Object(const _float & fTimeDelta)
{
	Effect();
...
void CBiShopStopBullet::Render_Object(const _int & iIndex)
{
...
HRESULT CBiShopStopBullet::Add_Component()
{
...
HRESULT CBiShopStopBullet::SetUp_ConstantTable(LPD3DXEFFECT & pEffect, const _int & iIndex)
{
...
void CBiShopStopBullet::Move(const _float & fTimeDelta)
{
}

void CBiShopStopBullet::Set_Dead(_bool bStack)
{
	m_bCol = false;
}

void CBiShopStopBullet::Effect()
{
...
CBiShopStopBullet * CBiShopStopBullet::Create(LPDIRECT3DDEVICE9 pGraphicDev, _vec3 vPos)
{
	CBiShopStopBullet*	pInstance = new CBiShopStopBullet(pGraphicDev);
...
void CBiShopStopBullet::Free(void)
{
	CEnermy::Free();
}
