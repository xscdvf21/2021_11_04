#ifndef VacuumField2_h__
#define VacuumField2_h__
...
class CVacuumField2 : public CScene , PxSimulationEventCallback
{
private:
	explicit CVacuumField2(LPDIRECT3DDEVICE9 pDevice);
	virtual ~CVacuumField2();
...
private:
	...
	void			Event_Vacuum_Ride(PxTriggerPair* pairs);
...
public:
	static CVacuumField2* Create(LPDIRECT3DDEVICE9 pGraphicDev);
