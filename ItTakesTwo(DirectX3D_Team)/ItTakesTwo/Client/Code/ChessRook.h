...
class CChessRook : public CEnermy
{
	//28, 23, 24, 27
	enum animID {
...
private:
	explicit CChessRook(LPDIRECT3DDEVICE9 pGraphicDev);
	virtual ~CChessRook();
...
public:
	static CChessRook*		Create(LPDIRECT3DDEVICE9 pGraphicDev, _uint iTileIndex = 0);
	virtual void Free(void)		override;

};

#define __CHESSROOK_H__
#endif
