#ifndef GrindStone_h__
#define GrindStone_h__
...
class CGrindStone : public Engine::CGameObject
{
private:
	explicit CGrindStone(LPDIRECT3DDEVICE9 pGraphicDev);
	virtual ~CGrindStone(void);
...
public:
	static CGrindStone*	Create(LPDIRECT3DDEVICE9 pGraphicDev, void* pArg = nullptr);
	OBJINFO					m_tObjInfo;
