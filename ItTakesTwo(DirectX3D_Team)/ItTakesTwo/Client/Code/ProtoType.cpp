...
CWarpGate::CWarpGate(LPDIRECT3DDEVICE9 pGraphicDev)
...
HRESULT CWarpGate::Ready_Object(void * pArg)
{
...
_int CWarpGate::Update_Object(const _float & fTimeDelta)
{
	if (m_bStart)
	{
		m_bStart = false;
...
_int CWarpGate::LateUpdate_Object(const _float & fTimeDelta)
{
	return _int();
}

void CWarpGate::Render_Object(const _int & iIndex)
{
...
HRESULT CWarpGate::Add_Component(void * pArg)
{
	...
	pComponent = m_pMeshCom = static_cast<Engine::CStaticMesh*>(Engine::Clone_Resource(tTemp.eSceneID, L"WarpGate"));
...
HRESULT CWarpGate::SetUp_ConstantTable(LPD3DXEFFECT & pEffect, const _int & iIndex)
{
...
CWarpGate * CWarpGate::Create(LPDIRECT3DDEVICE9 pGraphicDev, void * pArg)
{
	CWarpGate*	pInstance = new CWarpGate(pGraphicDev);
