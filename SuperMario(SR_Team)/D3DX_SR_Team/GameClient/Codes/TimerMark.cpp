...
HRESULT CTimerMark::Ready_GameObject(void* pArg)
{
    ...
    D3DXCreateFont(m_pDevice, 30, 30, 500, 1, false, DEFAULT_CHARSET, OUT_DEFAULT_PRECIS, DEFAULT_QUALITY, 0, L"나눔손글씨 펜", &m_pFont);
...
{
    CTimerMark* pInstance = new CTimerMark(*this); /*복사생성호출*/
