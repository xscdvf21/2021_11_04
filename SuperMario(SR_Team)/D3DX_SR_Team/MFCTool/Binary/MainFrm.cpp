	...
	CCreateContext* pContext)
{
	...
	//if (!m_wndSplitter.CreateView(0, 0, RUNTIME_CLASS(CMFCToolView/*뷰 추가.*/), CSize(nSizeX - nMenuSize, 0), pContext))
	//{
	//	return FALSE;
	//}
	//if (!m_wndSplitter.CreateView(0, 1, RUNTIME_CLASS(CMyFormView/*폼 추가*/), CSize(nMenuSize, 0), pContext))
	//{
	//	return FALSE;
	//}
	...
	g_pView = (CMFCToolView*)m_wndSplitter.GetPane(0, 0); //0, 0 은 View // 0, 1 은 Form
