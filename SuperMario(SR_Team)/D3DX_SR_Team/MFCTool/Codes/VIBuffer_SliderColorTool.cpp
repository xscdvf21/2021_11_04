#include "stdafx.h"
#include "..\Headers\VIBuffer_SliderColorTool.h"


CVIBuffer_SliderColor::CVIBuffer_SliderColor(_Device pDevice)
	: CVIBufferTool(pDevice)
{
}

CVIBuffer_SliderColor::CVIBuffer_SliderColor(const CVIBuffer_SliderColor& other)
	: CVIBufferTool(other)
{
}

HRESULT CVIBuffer_SliderColor::Ready_Component_Prototype()
{
...
HRESULT CVIBuffer_SliderColor::Ready_Component(void* pArg)
{
...
HRESULT CVIBuffer_SliderColor::Render_VIBuffer()
{
...
HRESULT CVIBuffer_SliderColor::Change_VertexColor(D3DCOLOR _Color, _uint iIndex)
{
	VTX_CUBECOLOR* pVertexArr = nullptr;
	m_pVB->Lock(0, 0, (void**)&pVertexArr, 0);
...
CVIBuffer_SliderColor* CVIBuffer_SliderColor::Create(_Device pDevice)
{
	CVIBuffer_SliderColor* pInstance = new CVIBuffer_SliderColor(pDevice);
...
CComponentTool* CVIBuffer_SliderColor::Clone(void* pArg)
{
	CVIBuffer_SliderColor* pClone = new CVIBuffer_SliderColor(*this);
...
void CVIBuffer_SliderColor::Free()
{
	CVIBufferTool::Free();
}
