...
CVIBuffer_CubeColorTool::CVIBuffer_CubeColorTool(LPDIRECT3DDEVICE9 pDevice)
	: CVIBufferTool(pDevice)
{
}

CVIBuffer_CubeColorTool::CVIBuffer_CubeColorTool(const CVIBuffer_CubeColorTool& other)
	: CVIBufferTool(other)
{
}

HRESULT CVIBuffer_CubeColorTool::Ready_Component_Prototype()
{
...
HRESULT CVIBuffer_CubeColorTool::Ready_Component(void* pArg)
{
...
HRESULT CVIBuffer_CubeColorTool::Render_VIBuffer()
{
...
HRESULT CVIBuffer_CubeColorTool::Change_VertexColor(D3DCOLOR _Color, _uint iIndex)
{
	/**
	*	1,6 : X
	*	2,5 : Y
...
CVIBuffer_CubeColorTool * CVIBuffer_CubeColorTool::Create(_Device pDevice)
{
	CVIBuffer_CubeColorTool* pInstance = new CVIBuffer_CubeColorTool(pDevice);
...
CComponentTool* CVIBuffer_CubeColorTool::Clone(void* pArg)
{
	CVIBuffer_CubeColorTool* pClone = new CVIBuffer_CubeColorTool(*this);
...
void CVIBuffer_CubeColorTool::Free()
{
	CVIBufferTool::Free();
}
